...
angular.module('mean.groups').controller('GroupsController', ['$scope', '$http', '$stateParams', '$location', 'Global', 'Groups', 'Estudiantes',
  function($scope, $http, $stateParams, $location, Global, Groups, Estudiantes) {
    // $scope.global = Global;
    // $scope.package = {
    //   name: 'groups'
    // };
